...
public class restfor8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restfor8);
    ...
    public void buttbridge(){
        Intent intent= new Intent(this, buttbridge.class);
