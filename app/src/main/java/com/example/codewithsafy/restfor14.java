...
public class restfor14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restfor14);
    ...
    public void legraises2(){
        Intent intent= new Intent(this,legraises2.class);
