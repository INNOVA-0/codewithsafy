...
public class thighrestfor14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thighrestfor14);
    ...
    public void  mountainclimber(){
        Intent intent= new Intent(this, sidelyingleft2.class);
