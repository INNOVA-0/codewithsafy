...
public class restfor11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restfor11);
    ...
    public void russiantwist2(){
        Intent intent= new Intent(this, russiantwist2.class);
