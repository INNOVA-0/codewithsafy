...
public class thighrestfor18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thighrestfor18);
    ...
    public void  mountainclimber(){
        Intent intent= new Intent(this, kneetochestleft.class);
