...
public class restfor18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restfor18);
    ...
    public void   lyingtwistleft(){
        Intent intent= new Intent(this, lyingtwistleft.class);
