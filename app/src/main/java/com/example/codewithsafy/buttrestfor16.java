...
public class buttrestfor16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buttrestfor16);
    ...
    public void highstepping(){
        Intent intent= new Intent(this,buttdonkeykicksright2.class);
