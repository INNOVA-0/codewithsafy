...
public class buttrestfor14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buttrestfor14);
    ...
    public void highstepping(){
        Intent intent= new Intent(this,buttmountainclimber2.class);
