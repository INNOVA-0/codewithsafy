...
public class buttrestfor7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buttrestfor7);
    ...
    public void highstepping(){
        Intent intent= new Intent(this, buttmountainclimber.class);
