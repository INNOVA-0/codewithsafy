...
public class buttdonkeykicksleft2 extends AppCompatActivity {
    ImageButton button;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_buttdonkeykicksleft2);
    ...
    public void restfor8(){
        Intent intent= new Intent(this, buttrestfor16.class);
