...
public class thighrestfor19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thighrestfor19);
    ...
    public void  mountainclimber(){
        Intent intent= new Intent(this, kneetochestright.class);
