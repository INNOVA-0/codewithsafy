...
public class thighrestfor13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thighrestfor13);
    ...
    public void  mountainclimber(){
        Intent intent= new Intent(this, backwardlunge2.class);
