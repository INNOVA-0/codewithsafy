...
public class kneetochestleft extends AppCompatActivity {
    private TextView textView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kneetochestleft);
    ...
    public void restfor3(){
        Intent intent= new Intent(this, thighrestfor19.class);
