...
public class buttdonkeykicksleft extends AppCompatActivity {
    ImageButton button;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_buttdonkeykicksleft);
    ...
    public void restfor8(){
        Intent intent= new Intent(this, buttrestfor9.class);
