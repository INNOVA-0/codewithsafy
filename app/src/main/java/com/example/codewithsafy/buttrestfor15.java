...
public class buttrestfor15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buttrestfor15);
    ...
    public void highstepping(){
        Intent intent= new Intent(this,buttdonkeykicksleft2.class);
