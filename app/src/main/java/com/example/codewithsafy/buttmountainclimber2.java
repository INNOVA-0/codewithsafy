...
public class buttmountainclimber2 extends AppCompatActivity {
    ImageButton button;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_buttmountainclimber2);
    ...
    public void restfor8(){
        Intent intent= new Intent(this, buttrestfor15.class);
