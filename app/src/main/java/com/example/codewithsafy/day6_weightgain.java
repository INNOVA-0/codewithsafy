...
public class day6_weightgain extends AppCompatActivity {
    ImageView backarrowday2;
    ImageView forwardarrowday1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_day6_weightgain);
    ...
    public  void openday5weightgain(){
        Intent intent= new Intent(this, day5_weightgain.class);
        startActivity(intent);
        overridePendingTransition(R.anim.left_slide_in,R.anim.right_slide_out);
    }
    public  void openday7weightgain(){
        Intent intent= new Intent(this, day7_weightgain.class);
        startActivity(intent);
