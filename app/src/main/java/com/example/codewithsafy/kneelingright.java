...
public class kneelingright extends AppCompatActivity {
    private TextView textView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kneelingright);
    ...
    public void thighrestfor2(){
        Intent intent= new Intent(this, buttcongratulations.class);
