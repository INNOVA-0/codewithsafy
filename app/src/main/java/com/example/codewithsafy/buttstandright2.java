...
public class buttstandright2 extends AppCompatActivity {
    ImageButton button;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_buttstandright2);
    ...
    public void restfor8(){
        Intent intent= new Intent(this, buttrestfor12.class);
