...
public class restfor19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restfor19);
    ...
    public void lyingtwistright(){
        Intent intent= new Intent(this, lyingtwistright.class);
