...
public class buttrestfor9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buttrestfor9);
    ...
    public void highstepping(){
        Intent intent= new Intent(this,buttdonkeykicksright.class);
