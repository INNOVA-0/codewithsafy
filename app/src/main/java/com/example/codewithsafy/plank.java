...
public class plank extends AppCompatActivity {
    ...
    public void restfor17(){
        Intent intent= new Intent(this, restfor17.class);
        startActivity(intent);

    }
    public  void youtuber(View view){
        Intent youtuberintent =new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=B296mZDhrP4"));
