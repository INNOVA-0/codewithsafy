...
public class splitsquatpress extends AppCompatActivity {
    private TextView textView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_splitsquatpress);
    ...
    public void thighrestfor2(){
        Intent intent= new Intent(this, armrestfor11.class);
