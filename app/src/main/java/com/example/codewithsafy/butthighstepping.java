...
public class butthighstepping extends AppCompatActivity {
    private TextView textView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_butthighstepping);
    ...
    public void thighrestfor2(){
        Intent intent= new Intent(this, buttrestfor2.class);
