...
public class thighrestfor2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thighrestfor2);
    ...
    public void highstepping(){
        Intent intent= new Intent(this, thighjumpingjack.class);
