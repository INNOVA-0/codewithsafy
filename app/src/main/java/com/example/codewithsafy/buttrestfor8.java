...
public class buttrestfor8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buttrestfor8);
    ...
    public void highstepping(){
        Intent intent= new Intent(this,buttdonkeykicksleft.class);
