...
public class restfor12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restfor12);
    ...
    public void  mountainclimber2(){
        Intent intent= new Intent(this, donkeyright2.class);
