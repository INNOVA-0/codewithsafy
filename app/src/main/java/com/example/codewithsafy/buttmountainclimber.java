...
public class buttmountainclimber extends AppCompatActivity {
    ImageButton button;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_buttmountainclimber);
    ...
    public void restfor8(){
        Intent intent= new Intent(this, buttrestfor8.class);
