...
public class restfor13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restfor13);
    ...
    public void flutterkicks2(){
        Intent intent= new Intent(this,flutterkicks2.class);
