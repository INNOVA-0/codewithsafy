...
public class restfor15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restfor15);
        ...
        long duration = TimeUnit.SECONDS.toMillis(14);
    ...
    public void buttbridge2(){
        Intent intent= new Intent(this, buttbridge2.class);
