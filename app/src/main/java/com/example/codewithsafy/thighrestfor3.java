...
public class thighrestfor3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thighrestfor3);
    ...
    public void standingbicycle(){
        Intent intent= new Intent(this, thighsquats.class);
