...
public class buttdonkeykicksright2 extends AppCompatActivity {
    ImageButton button;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_buttdonkeykicksright2);
    ...
    public void restfor8(){
        Intent intent= new Intent(this, buttrestfor17.class);
