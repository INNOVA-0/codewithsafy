...
public class restfor10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restfor10);
    ...
    public void standingbicycle2(){
        Intent intent= new Intent(this, standingbicycle2.class);
