...
public class thighrestfor15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thighrestfor15);
    ...
    public void  mountainclimber(){
        Intent intent= new Intent(this, sidelyingright2.class);
